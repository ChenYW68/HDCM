...
writexl::write_xlsx(temp0, path = "./Result/STVCxzp_varyingBeta1_INLAs_cv.xlsx")
writexl::write_xlsx(Inla, path = "./Result/STVCxzp_varyingBeta1_pred_INLAs_cv.xlsx")
