...
temp <- temp[, c(1:3, 6, 5)]
temp
writexl::write_xlsx(temp, path = "./Result/STVCs_cv.xlsx")
writexl::write_xlsx(STVC, path = "./Result/pred_STVCs_cv.xlsx")
# writexl::write_xlsx(temp, path = "./Result/orig_STVCs_cv.xlsx")
# writexl::write_xlsx(STVC, path = "./Result/orig_pred_STVCs_cv.xlsx")
#
