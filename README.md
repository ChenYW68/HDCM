...
- Large datasets: $PM_{2.5}$ concentrations from the reanalysis $PM_{2.5}$ outputs of the Nested Air Quality Prediction Modeling System (NAQPMS, Wang et al., (2006)) and from the raw $PM_{2.5}$ outputs of the CMAQ, and the sizes are $6{,}382 \times 30 = 191{,}460$ reanalysis $PM_{2.5}$ outputs and $16{,}093 \times 30 = 482{,}790$ $PM_{2.5}$ outputs, respectively 
